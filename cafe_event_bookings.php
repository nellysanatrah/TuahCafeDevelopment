...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_booking'])) {
    ...
    full_name, phone_number, membership_status, 
    jenis_acara, event_name, tarikh_acara, 
    start_time, end_time, venue, package_selected, pax_count, 
    menu_details, addons_details, special_remarks, created_at, is_read
) VALUES (
    :full_name, :phone_number, :membership_status, 
    :jenis_acara, :event_name, :tarikh_acara, 
    :start_time, :end_time, :venue, :package_selected, :pax_count, 
    :menu_details, :addons_details, :special_remarks, NOW(), 0
)";
...
$stmt->bindParam(':jenis_acara', $event_type);
$stmt->bindParam(':event_name', $event_name);
$stmt->bindParam(':tarikh_acara', $event_date);
